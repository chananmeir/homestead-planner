...
1. **Calendar month-grid editing** — the grid view's event editing is marked TODO
   (`PlantingCalendar/index.tsx` ~line 693); edits work from list view / detail modals.
   Intentional scope cut or unfinished?
