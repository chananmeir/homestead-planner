...
// [UNUSED-2026-06-10] Dead subtree commented out by unused-code audit:
// isCellInFootprintBedAware (+ its private MIGardener/Intensive variants, the
// isCellInFootprint primitive they wrap, formatFootprintSize, and this params
// interface) have zero references outside this file. The live API is
// calculateSpacingBuffer / calculateFootprint / calculateFootprintBedAware below.
// /**
